...
const OrderOnline = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-white dark:bg-black transition-colors duration-700">
      {/* Gradient overlay */}
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl relative z-10 text-center">
        ...
        <p
          className="text-lg max-w-2xl mx-auto mb-12 text-gray-700 dark:text-gray-300"
          data-aos="fade-up"
          data-aos-delay={200}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {partners.map((partner, index) => (
            <div
              key={index}
              className={`rounded-2xl p-8 flex flex-col items-center justify-between
                          bg-white dark:bg-[#1B1B1B] shadow-lg transition duration-500 ease-out
                          hover:-translate-y-2 hover:shadow-[0_0_30px_${partner.color}] 
                          active:shadow-[0_0_30px_${partner.color}]`}
              data-aos="zoom-in"
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  color: partner.color === "#FFB612" ? "#000000" : "#000000",
                }}
              >
                {partner.abbr}
              </div>
              ...
              <a
                ...
                className="w-full px-6 py-3 rounded-lg font-medium shadow transition duration-300 hover:scale-105 text-center"
                style={{
